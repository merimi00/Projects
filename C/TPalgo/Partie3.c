...
void bis_print_normal (image i){
    ...
    if (i == NULL){
        ...
        return;
            ...
            printf("+");
            printf("B");
            bis_print_normal(i->fils[0]);
            bis_print_normal(i->fils[1]);
            bis_print_normal(i->fils[2]);
            bis_print_normal(i->fils[3]);
    }
...
int main() {
    ...
    //printf("\n");
    //print_profondeur(n);
    //printf("%s \n", estNoire(n) ? "true" : "false");

    //image b = construit_blanc();
    //printf("%s \n", estBlanche(b) ? "true" : "false");
